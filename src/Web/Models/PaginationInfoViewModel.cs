...
namespace Web.Models
{
    public class PaginationInfoViewModel
    {
        ...
        public int TotalPages => (int)Math.Ceiling(TotalItems / (double)Constant.ITEMS_PER_PAGE);

        public int DisplayStart => (CurrentPage - 1) * Constant.ITEMS_PER_PAGE + 1;

        public int DisplayEnd => (CurrentPage - 1) * Constant.ITEMS_PER_PAGE + ItemsOnPage;
